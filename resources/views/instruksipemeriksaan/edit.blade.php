            ...
            <div class="col-md-12">
                ...
                <h3>Rekam IP :</h3>
                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('instruksi-pemeriksaan.update', $dokumen->id) }}">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('tingkat_periksa') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="tingkat_periksa" type="text" class="form-control" name="tingkat_periksa" value="{{$dokumen->ip->tingkat_periksa}}">
                            ...
                            <div class="form-group{{ $errors->has('aju_contoh') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="aju_contoh" id="aju_contoh">
                                        <option value="{{$dokumen->ip->aju_contoh}}" selected>{{$dokumen->ip->aju_contoh}}</option>
                            ...
                            <div class="form-group{{ $errors->has('aju_foto') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="aju_foto" id="aju_foto">
                                        <option value="{{$dokumen->ip->aju_foto}}" selected>{{$dokumen->ip->aju_foto}}</option>
                                        <option value="YA"> YA</option>
                                        <option value="TIDAK"> TIDAK</option>
                                    </select>
