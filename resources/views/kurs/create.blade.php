    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Rekam Kurs</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('kurs.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('nilai') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nilai" type="text" class="form-control" name="nilai" value="{{ old('nilai') }}">
                        ...
                        <div class="form-group{{ $errors->has('berlaku') ? ' has-error' : '' }}" id="tgl">
                            ...
                            <div class="col-md-6">
                                <input id="berlaku" type="text" class="form-control" name="berlaku" value="{{ old('berlaku') }}">
                        ...
                        <div class="form-group{{ $errors->has('sampai') ? ' has-error' : '' }}" id="tgl">
                            ...
                            <div class="col-md-6">
                                <input id="sampai" type="text" class="form-control" name="sampai" value="{{ old('sampai') }}">
