...
Route::middleware(['auth'])->group(function () {
    ...
    // Route::get('/rekam-dokumen', 'RekamDokumenController@create')->name('dokumen.create');
    ...
    Route::get('/laporan-download-dokumen-jaminan', 'LaporanController@downloadDokumenJaminan')->name('laporan.downloadDokumenJaminan');
    ...
    //MY DOKUMEN
    Route::resource('/mydokumen', 'MyDokumenController');
    Route::post('/mydokumen-kirim/{dokumen}', 'MyDokumenController@kirim')->name('mydokumen.kirim');
    Route::get('/my-edit-detail-barang/{dokumenDetail}', 'MyDokumenController@editDetail')->name('mydokumen.editDetail');
